...
export const ProjectCard = ({ title, date, description, links, skills }: ProjectType) => {
    return (
        ...
        after:h-20 after:w-px after:absolute after:-left-px after:top-3/4 after:opacity-0 after:bg-gradient-to-b after:from-transparent after:via-purple-700 after:to-transparent
